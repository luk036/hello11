...
Welcome to `hello1` contributor's guide.
...
If you experience bugs or general issues with `hello1`, please have a look
...
You can help improve `hello1` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hello1` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hello1`'s files. While this mechanism can
...
```
conda create -n hello1 python=3 six virtualenv pytest pytest-cov
conda activate hello1
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hello1.git
   cd hello1
   ```
...
5. Install [pre-commit]:
   ...
   `hello1` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hello1
[issue tracker]: https://github.com/<USERNAME>/hello1/issues
